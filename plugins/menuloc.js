  ...
  try {
    ...
    if (teks == '404') {
      return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          "title": `Hi 👋 ${ucapan()}, ${name} Welcome`.trim(),
          "description": "© sekha",
          "buttonText": "𝐥𝐢𝐬𝐭 𝐦𝐞𝐧𝐮",
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(cecan + 'apirey')).buffer(), text.trim(), '                               𝚂 𝙲 𝙾 𝙳 𝙴 𝚁 𝚂 💫\n\n\n                           www.studycoders.site\n\n\n                       𝑩𝒚 𝑷𝒖𝒓𝒘𝒐𝒅𝒂𝒅𝒊 𝒌𝒐𝒕𝒂 𝒔𝒘𝒆𝒌𝒆 🐸    ', 'owner', `${_p}owner`, 'donasi', `${_p}donasi`, m)
